...
// TODO: Set up the zip-for-installer script to strip the asset store folders
{
    ...
    private const float menuWidth = 200.0f,
                        menuHeight = 241.0f,
                        menuHeaderHeight = 26.0f,
                        buttonWidth = 175.0f,
                        buttonHeight = 30.0f;

    private bool directKeyQuit = true;

    private bool fullScreenAvailable;
    ...
    {
        get { return PlayerPrefs.GetInt("Play audio", 1) != 0; }
        set
        {
    ...
    private void OnGUI()
    {
        var rightRect = new Rect(Screen.width - cornerTextureSize, 0.0f, cornerTextureSize, cornerTextureSize);
    ...
    private bool MenuButton(Texture2D icon)
    {
        ...
        Rect rect = GUILayoutUtility.GetRect(buttonWidth, buttonHeight, GUILayout.Width(buttonWidth),
